            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('profil') }}">
                        ...
                        <div class="form-group row">
                            <label for="nohp" class="col-md-2 col-form-label text-md-right">Usia</label>

                            <div class="col-md-6">
                                <input id="usia" type="text" class="form-control @error('usia') is-invalid @enderror" name="usia" value="{{ $user->usia }}" required autocomplete="usia" autofocus>
